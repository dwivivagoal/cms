                                ...
                                <div class="ts-grid-box tabs-item mb-30 bg-dark-item white-text ">
                                    <div class="clearfix ts-tab-style">
                                        ...
                                        <ul class="tab-menu-item nav float-right" role="tablist" id="vinkmagposttab22717f7cTab">
                                                {VIDEO_KATEGORI_LIST}
                                                <li class="nav-item">
                                                    <a class="nav-link {active}" href="#tab-{alias}" role="tab" data-toggle="tab" {selected}>{title}</a>
                                                </li>
                                                {/VIDEO_KATEGORI_LIST}
                                    ...
                                    <div class="tab-content ts-tabs-content" id="vinkmagposttab22717f7cTabContent">
                                        ...
                                        <div role="tabpanel" class="tab-pane {css_active}" id="tab-{alias}">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="nav post-list-box" role="tablist">
                                                        ...
                                                        <a class="nav-item nav-link active" 
                                                            ...
                                                            data-toggle="tab" 
                                                            href="#nav-post-tab-{galeri_id}" role="tab" aria-controls="nav-post-tab-{galeri_id}"
                                                            aria-selected="true">
                                                            <div class="post-content media">
                                                                ...
                                                                <div class="media-body align-self-center">
                                                                    ...
                                                                    <span class="post-date-info"><i class="fa fa-clock-o"></i> {publish_date}</span>
                                                                </div>
                                                            </div>
                                                        </a>
                                    ...
                                    <div class="elementor-widget-container">
                                        <div class="ts-grid-box widgets category-list-item  grid-no-shadow">
                                                ...
                                                <ul class="category-list">
                                                                            <li><a href="#">Surfing<span style="color:#ffffff; background-color:#d72924; border-left-color:#d72924">4</span></a></li>                        
                                                                            <li><a href="#">Sports<span style="color:#ffffff; background-color:#d72924; border-left-color:#d72924">7</span></a></li>                        
                                                                            <li><a href="#">Sketing<span style="color:#ffffff; background-color:#d72924; border-left-color:#d72924">6</span></a></li>                        
                                                                            <li><a href="#">Football<span style="color:#ffffff; background-color:#e21e22; border-left-color:#e21e22">5</span></a></li>                        
                                                                            <li><a href="#">Cricket<span style="color:#ffffff; background-color:#d72924; border-left-color:#d72924">6</span></a></li>                
                                                </ul>
                                            </div>
